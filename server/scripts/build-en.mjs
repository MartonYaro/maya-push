...
const TITLE_EN = 'MAYA Push — Motivated Installs & ASO for App Store and Google Play';
const DESC_EN  = 'MAYA Push — motivated installs and ASO promotion for the App Store and Google Play: real devices and local IPs in any geo, transparent per-install pricing and a real-time install table. No minimum to start.';
