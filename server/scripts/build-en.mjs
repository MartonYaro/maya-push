...
const TITLE_EN = 'Motivated Installs & ASO for App Store & Google Play — MAYA Push';
const DESC_EN  = 'Motivated installs and ASO promotion for the App Store and Google Play. Real devices and local IPs in any geo, transparent per-install pricing and a real-time install dashboard. No minimum to start.';
